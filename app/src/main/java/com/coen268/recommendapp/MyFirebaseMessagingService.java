...
//            PendingIntent intent = new PendingIntent(MyFirebaseMessagingService.this, PicActivity.class);
//            intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
//            intent.putExtra(Extra_PICTURE, (String) remoteMessage.getNotification().getImageUrl().toString());
